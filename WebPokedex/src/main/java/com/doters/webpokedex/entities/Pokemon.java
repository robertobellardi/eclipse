...
public class Pokemon {
	...
	@JoinTable(
		...
		inverseJoinColumns = @JoinColumn(name = "mosse_id"))
	private List<Mosse2> listaMosse;
	...
	public List<Mosse2> getListaMosse() {
		return listaMosse;
	}

	public void setListaMosse(List<Mosse2> listaMosse) {
